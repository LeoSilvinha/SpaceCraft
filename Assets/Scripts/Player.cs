...
public class Player : MonoBehaviour
{
    ...
    public float tempoDisparo = 0.1f;
    public float podeDisparar = 0.1f;
    ...
    void Update()
    {
        ...
        if ( Input.GetKeyDown(KeyCode.Space) || Input.GetMouseButtonDown(0))
            if ( Time.time > podeDisparar ){
                ...
                Instantiate(pfLaser,transform.position + new Vector3 (0,0.1f,0),Quaternion.identity);
            }
            
            podeDisparar = Time.time + tempoDisparo;
        }
